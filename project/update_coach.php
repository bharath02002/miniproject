...
if (isset($_REQUEST['trainer'])) {
  ...
  $update_query="update coach set coach_id='$trainer_id',name='$name',time='$time',mobileno='$mobileno' where coach_id='".$_GET['id']."'";
  $update_sql=mysqli_query($conn,$update_query);
  $err="<div class='alert alert-success'><b>Coach Details updated</b></div>";
}
$con=mysqli_query($conn,"select * from coach where coach_id='".$_GET['id']."'");
