...
if (isset($_REQUEST['member'])) {
  ...
  $update_query="update athlete set athlete_id='$mem_id',name='$name',age='$age',dob='$dob',facilityname='$package',mobileno='$mobileno' where athlete_id='".$_GET['id']."'";
  $update_sql=mysqli_query($conn,$update_query);
  $err="<div class='alert alert-success'><b>Athletes Area Details updated</b></div>";
}
$con=mysqli_query($conn,"select * from athlete where athlete_id='".$_GET['id']."'");
